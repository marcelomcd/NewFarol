...
const SlideCausaRaizMelhoriasDezembro = () => {
    ...
    useEffect(() => {
        ...
        const carregarDados = async () => {
            try {
                ...
                const response = await fetch('/dados/Chamados Causa Raiz Combio - Dezembro 2025.xlsx');
...
export default SlideCausaRaizMelhoriasDezembro;
