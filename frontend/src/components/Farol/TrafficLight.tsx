  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="bg-gray-800 dark:bg-gray-700 rounded-xl p-6 shadow-xl border-2 border-gray-900 dark:border-gray-800">
                ...
                >
                  ...
                  {isActive && (
                    <div className="absolute inset-0 flex items-center justify-center z-10">
                      <span className="text-white font-bold text-xl drop-shadow-xl">
                        {data.count}
                      </span>
                    </div>
                  )}
